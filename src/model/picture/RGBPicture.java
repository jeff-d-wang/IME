...
/**
 * Abstract class that is representative of a Picture that uses RGB values to define itself.
 */
public abstract class RGBPicture implements IPicture {
  ...
  /**
   * Basic constructor for the RGBPicture abstract class.
   * @param width    Width of the picture
   * @param height   Height of the picture
   * @throws IllegalArgumentException if the given width and/or height is negative
   */
