...
public class PictureModelTest {
  ...
  public void testPutAndGetPicture() throws IOException {
    IPicture filePicture1 = ImageUtil.readPPM("src/pictures/smallImage/smallImage.ppm");
    IPicture filePicture2 = ImageUtil.readPPM("src/pictures/smallImage/smallImage-horizontal.ppm");
    IPicture filePicture3 = ImageUtil.readPPM("src/pictures/smallImage/smallImage-value-greyscale.ppm");
    ...
    for (int r = 0; r < model1.getPicture("smallImage1").getHeight(); r++) {
      for (int c = 0; c < model1.getPicture("smallImage1").getWidth(); c++) {
        assertEquals(model1.getPicture("smallImage1").getPixel(r, c), filePicture1.getPixel(r, c));
      }
    }

    for (int r = 0; r < model1.getPicture("smallImage2").getHeight(); r++) {
      for (int c = 0; c < model1.getPicture("smallImage2").getWidth(); c++) {
        assertEquals(model1.getPicture("smallImage2").getPixel(r, c), filePicture2.getPixel(r, c));
      }
    }

    for (int r = 0; r < model1.getPicture("smallImage3").getHeight(); r++) {
      for (int c = 0; c < model1.getPicture("smallImage3").getWidth(); c++) {
        assertEquals(model1.getPicture("smallImage3").getPixel(r, c), filePicture3.getPixel(r, c));
      }
    }
  ...
  public void testInvalidPutPicture() throws IOException {
    IPicture filePicture = ImageUtil.readPPM("src/pictures/smallImage/smallImage.ppm");
